...
export default class CartRouter extends BaseRouter {
    ...
    initialize() {
        ...
        this.addPutRoute("/:id", [ PREMIUM, STANDARD ], (req, res) => this.#cartController.update(req, res));
        this.addDeleteRoute("/:id", [ ADMIN, STANDARD ], (req, res) => this.#cartController.delete(req, res));
        ...
        this.addPostRoute("/:cid/purchase", [STANDARD], (req, res) => this.#cartController.purchaseCart(req, res));
